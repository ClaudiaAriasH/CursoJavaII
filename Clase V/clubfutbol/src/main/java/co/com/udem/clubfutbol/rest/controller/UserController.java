...
import co.com.udem.clubfutbol.dto.entities.User;
import co.com.udem.clubfutbol.repositories.UserRepository;
...
public class UserController {
	...
	public Map<String, String> adicionarUsuario(@RequestBody User user) {
		...
		userRepository.save(User.builder().username(user.getUsername())
				.password(this.passwordEncoder.encode(user.getPassword())).roles(Arrays.asList("ROLE_USER")).build());
